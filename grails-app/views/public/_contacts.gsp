    ...
    <g:each in="${it}" var="cf">
      <div class="contact">
        <p>
            ...
            <g:if test="${cf?.role}"><g:message code="public.show.contacts.role" default="role"/>: ${cf?.role}<br/></g:if>
            <g:if test="${cf?.contact?.phone}"><g:message code="public.show.contacts.phone" default="phone"/>: ${cf?.contact?.phone}<br/></g:if>
            <g:if test="${cf?.contact?.fax}"><g:message code="public.show.contacts.fax" default="phone"/>: ${cf?.contact?.fax}<br/></g:if>
